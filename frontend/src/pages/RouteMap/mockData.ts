...
export const mockRouteKremlin: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.330, longitude: 44.003 }, // Никольская башня
        { latitude: 56.331, longitude: 44.001 }, // Коромыслова башня
        { latitude: 56.330, longitude: 43.998 }, // Тайницкая башня
        { latitude: 56.328, longitude: 43.999 }, // Северная башня
        { latitude: 56.327, longitude: 44.000 }, // Ивановская башня
...
export const mockRoutePokrovskaya: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.320, longitude: 43.995 }, // Здание Государственного банка
...
export const mockRouteFedorovskogo: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.320, longitude: 44.006 }, // Чкаловская лестница (вид сверху)
...
export const mockRouteChkalovStairs: RouteData = {
    ...
    checkpoints: [
        { latitude: 56.320, longitude: 44.006 }, // Верхняя точка (памятник Чкалову)
        ...
        { latitude: 56.320, longitude: 44.006 }, // Возврат к памятнику
    ],
    categories: [
        { id: 10, name: 'Лестница' },
        { id: 11, name: 'Монумент' },
...
export const mockRouteStrelka: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.340, longitude: 43.982 }, // Причал
        { latitude: 56.342, longitude: 43.986 }, // Смотровая площадка
        { latitude: 56.341, longitude: 43.990 }, // Парк
...
export const mockRouteAlexandrovskyGarden: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.322, longitude: 44.000 }, // Фонтан
        { latitude: 56.321, longitude: 43.999 }, // Детская площадка
        { latitude: 56.320, longitude: 43.998 }, // Скамейки у воды
        { latitude: 56.319, longitude: 43.997 }, // Ротонда
        { latitude: 56.320, longitude: 43.996 }, // Мостик
        { latitude: 56.321, longitude: 43.998 }, // Аллея
        { latitude: 56.322, longitude: 44.000 }, // Возврат к фонтану
    ],
    categories: [
        { id: 16, name: 'Парк' },
        { id: 17, name: 'Отдых' },
...
export const mockRouteSwitzerlandPark: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.310, longitude: 44.005 }, // Детский городок
...
export const mockRouteCableCar: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.341, longitude: 44.020 }, // Опора 3
...
export const mockRouteRozhdestvenskaya: RouteData = {
    ...
    difficulty: 'EASY',
    checkpoints: [
        { latitude: 56.327, longitude: 44.010 }, // Площадь Народного Единства
        ...
        { latitude: 56.322, longitude: 44.000 }, // Блиновский пассаж
...
export const mockRouteSormovskyPark: RouteData = {
    ...
    checkpoints: [
        ...
        { latitude: 56.360, longitude: 43.878 }, // Аттракционы
        { latitude: 56.358, longitude: 43.882 }, // Спортивная зона
        { latitude: 56.355, longitude: 43.880 }, // Кафе
...
export const mockRouteMyza: RouteData = {
    ...
    difficulty: 'HARD',
    checkpoints: [
        { latitude: 56.282, longitude: 43.970 }, // Вход
        { latitude: 56.285, longitude: 43.975 }, // Лесная тропа
        { latitude: 56.289, longitude: 43.980 }, // Родник
        { latitude: 56.293, longitude: 43.985 }, // Поляна
        { latitude: 56.297, longitude: 43.990 }, // Смотровая
...
export const getMockRoutesByCategory = (categoryName: string): RouteData[] => {
    return mockRoutes.filter(route =>
        route.categories?.some(cat => cat.name.toLowerCase().includes(categoryName.toLowerCase()))
    );
};
