        ...
        <div className="filter-panel">
            ...
            <div className="filter-section">
                ...
                <ReactSlider
                    ...
                    onChange={(value) =>
                        setTempFilters({ ...tempFilters, durationFrom: value[0], durationTo: value[1] })
                    }
                    min={0}
                    max={100}
                />
            ...
            <div className="filter-section">
                ...
                <ReactSlider
                    ...
                    onChange={(value) =>
                        setTempFilters({ ...tempFilters, distanceFrom: value[0], distanceTo: value[1] })
                    }
                    min={0}
                    max={100000}
                />
                <div className="slider-labels">
                    <span>от {tempFilters.distanceFrom} км</span>
                    <span>до {tempFilters.distanceTo} км</span>
                </div>
            </div>
